...
export const PLATFORMS = [
  ...
  { id: 'other',     label: 'Autre',     icon: '?',  color: C.muted },
]

export const ACCOUNT_STATUSES = [
  { id: 'warmup',  label: 'Warmup',  color: C.blue   },
  { id: 'actif',   label: 'Actif',   color: C.green  },
  { id: 'banni',   label: 'Banni',   color: C.red    },
  { id: 'archive', label: 'Archivé', color: C.muted  },
]

export const DAYS = ['Lun', 'Mar', 'Mer', 'Jeu', 'Ven', 'Sam', 'Dim']

export const INV_CATS = [
  { id: 'va',          label: 'VA',          color: C.blue   },
  { id: 'modele',      label: 'Modèle',      color: C.accent },
  { id: 'outil',       label: 'Outil',       color: C.purple },
  { id: 'prestataire', label: 'Prestataire', color: C.orange },
  { id: 'autre',       label: 'Autre',       color: C.muted  },
]
