...
export default function Login() {
  ...
  async function handleLogin(e) {
    ...
    // Si ok, AppContext prend le relais via onAuthStateChange
  }
    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 400 }}>
        ...
        <div style={{ ...st.card(28) }}>
          {mode === 'login' ? (
            <>
              <div style={{ fontWeight: 700, fontSize: 18, marginBottom: 4 }}>Connexion</div>
              <div style={{ ...st.sub, marginBottom: 24 }}>Accès réservé à l'équipe IMPERIUM</div>
              ...
              <button
                ...
                style={{
                  ...
                  marginTop: 16, display: 'block', width: '100%', textAlign: 'center',
                  fontFamily: "'DM Sans', sans-serif",
                }}
              >
                Mot de passe oublié ?
            ...
            <>
              ...
              <div style={{ ...st.sub, marginBottom: 24 }}>
              ...
              {resetSent ? (
                <div style={{
                  ...
                  color: C.green, fontSize: 13, textAlign: 'center',
                }}>
                ...
                <form onSubmit={handleReset}>
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    style={{ ...st.btn('primary'), width: '100%', justifyContent: 'center', padding: '11px' }}
                  >
